...
#SBATCH --job-name calc_allsymptoms_1snp_cauchy
...
####################
#SBATCH -o calc_allsymptoms_1snp_cauchy.out
#SBATCH -e calc_allsymptoms_1snp_cauchy.out
...
##source activate r
srun Rscript -e 'source("calc_allsymptoms_1snp.R")'
