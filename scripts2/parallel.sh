...
#SBATCH --job-name calc_1symptom_3snps_gamma
...
####################
#SBATCH -o calc_1symptom_3snps_gamma.out
#SBATCH -e calc_1symptom_3snps_gamma.out
...
##source activate r
srun Rscript -e 'source("calc_1symptom_3snps.R")'
