...
%% Last-Updated: 2018-11-27T00:18:38+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  =
\binom{N_{\ya}}{N_{\ya}\,F_{\ysA\|\ya}}\;  {f_{\ysA\|\ya}}^{N_{\ya}\,F_{\ysA\|\ya}} \;
...
\begin{equation}
  ...
  =
 \prod_{x=\ya,\yb} \binom{N_{x}}{N_{x}\,F_{\ysA\|x}}\;{f_{\ysA\|x}}^{N_{x}\,F_{\ysA\|x}} \;
...
\begin{equation}
  ...
  \pf(f_{\ysA\|\ya}, f_{\ysA\|\yb}\| \yD,\yua,\yub,\yI)\;
  %   \dbeta(f_{\ysA\|\ya} \| \yua,\yub)\,
  % \dbeta(f_{\ysA\|\yb} \| \yua,\yub)\;
  \dA(\yua,\yub \|\yD, \yI),
\end{equation}
