...
%% Last-Updated: 2018-11-17T18:23:57+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
% \begin{equation}
%   \label{eq:distribution_difference}
%     \pf(\ptext{frequency difference} \| \ptext{data}, \ptext{initial info})
% \end{equation}
...
% See for example the distributions in \fig~\ref{fig:example_distributions}:
% from the sample data we expect conditional frequencies $0.259$ and $0.284$
% for the symptom conditional on the two alleles, with standard deviations
...
\section{Inference: concrete calculation}
\label{sec:inference}
...
parameters. This construction has the interesting consequence that the our
updated belief $\pf(f_{\ysA\|\ya}, f_{\ysA\|\yb} \| \yD, \yI)$ can be
