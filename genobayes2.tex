...
%% Last-Updated: 2018-11-27T14:56:40+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
is through a distribution of plausibility $\pf(\df)$ like the one plotted in
...
highly sure about: $x$ such that $\pf(\abs{\df}\ge x)=0.9$. For the plot of
