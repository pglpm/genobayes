...
%% Last-Updated: 2018-11-12T23:53:52+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\end{enumerate}
The first assumption is conservative; if our updated belief conditional on
...
conservative belief. The density representing this initial belief is
qualitatively shown in \fig~\ref{fig:initial_belief}.
