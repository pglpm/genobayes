...
%% Last-Updated: 2018-11-28T23:59:32+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
number. For example, we could use the lowest 10-quantile of
$\pf(\abs{\df})$ as minimal frequency difference we are highly sure about:
