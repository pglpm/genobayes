...
%% Last-Updated: 2018-11-28T00:37:08+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
The integral expression~\eqref{eq:conservative_prior} can be interpreted
this way: we consider several independent beliefs about of the two
...
that is not independent about the two frequencies. The particular shape and
scale values of the gamma density are chosen so as to concentrate our
initial belief along the $(f_{|\ya}, f_{|\yb})$ diagonal; this choice has
also a deeper interpretation, discussed in appendix***.
...
\begin{equation}
  ...
  =
\prod_{x=\ya,\yb}
\dbeta[f_{|x} \bigcond N_{x}\,F_{|x}+1, \yub+N_{x}\,(1-F_{|x})+1]
