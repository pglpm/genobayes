...
%% Last-Updated: 2018-11-28T18:00:10+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\headtitle}{\textsc{dna}, insomnia, and Bayes}
...
\begin{figure}[p!]%{r}{0.4\linewidth} % with wrapfigure
 \centering\includegraphics[height=\textheight]{relevance-sym_O.pdf}\hspace*{\stretch{1}}\includegraphics[height=\textheight]{relevance-sym_M.pdf}\hspace*{\stretch{1}}\includegraphics[height=\textheight]{relevance-sym_T.pdf}\\
