...
%% Last-Updated: 2018-11-11T23:00:06+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
mechanisms and our uncertainty about them. Consider a particular \snp\ and
a symptom $S$. In an arbitrarily large population, if the individuals
having one allele and those having the other allele show markedly different
\emph{conditional frequencies} of incidence of the symptom, then we can
conclude that the \snp\ must have some causal relevance, however indirect,
for the symptom.
