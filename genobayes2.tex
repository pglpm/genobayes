...
%% Last-Updated: 2018-11-27T12:15:42+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
large population is unknown however; we can at most make a plausible
inference about its value. The most complete statement we can make about it
is through a plausibility distribution like that plotted in
...
This distribution gives us many pieces of information: for example, it is
8.3\% plausible that the difference $\abs{\df}<0.01$, and therefore 91.7\%
plausible that $\abs{\df}>0.01$; it is 90\% plausible that
$-0.045 < \df < -0.007$, and so on. Several measures


The conditional frequencies and their difference are unknown, so we can
only make plausible inferences about them. We want to quantify our \dob\
about their values, given
...
quantify our belief we can use Bayes's theorem:
\begin{multline}
...
reasonable ways; we'll see, however, that they all lead to very similar final
\dobs\ about the conditional frequencies, owing to our large sample size.
