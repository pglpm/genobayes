...
%% Last-Updated: 2019-08-25T18:32:07+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
shown in \fig~\ref{fig:example_difference_distributions}. This distribution
is conditional on: \begin{enumerate*}[label=(\alph*)]
\item the data we've collected, \item our initial information or guesses
...
frequencies, from which $\pf(\df)$ can be calculated. This joint
distribution is therefore the starting point of our investigation. Our
