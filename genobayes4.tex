...
%% Last-Updated: 2019-08-25T20:00:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
distribution:
\begin{enumerate*}[label=(\roman*)]
\item the probability of observing our sampled data if we had known the
...
\end{enumerate*}
The first is given by a sampling formula. The second can be modelled in
several reasonable ways, and we'll see that, owing to the large size of our
sample, they all lead to very similar conclusions about the conditional
frequencies and their difference.
