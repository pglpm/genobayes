...
%% Last-Updated: 2019-08-26T10:58:08+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The plausibility of obtaining the data if we had known the frequencies in
...
The plausibility for our full data set $(F_{|\ya},F_{|\yb})$ is therefore
