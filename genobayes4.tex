...
%% Last-Updated: 2019-08-24T18:08:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\ysO}{\textrm{N}}% onset insomnia
...
The purpose of the present work is to investigate the statistical link or relation
between some insomnia symptoms and a specific set of \snp s. Our approach
is characterized by two main features:
\begin{enumerate}[wide]
\item We quantify the probable link between these two variates in a
  ...
  kind of dichotomous question very artificial, and their yes/no answers
  liable to an arbitrary choice of cut-off. Our results
  ...
  division. Any such cut-off should be made case by case depending on the
  further research questions asked. For example, one research group might
  want to further investigate some specific \snp s, but have budget and
  resources only for two; in this case they'd choose the two most strongly
  linked \snp s. Another research group might have enough budget and
  resources for five; they'd choose the five most strongly linked \snp s.

  Our perspective reflects recent foundational reevaluations and
  recommendations in the Probability \amp\ Statistics community
  \citep{asa2016,asa2019,amrheinetal2019}[see
