...
%% Last-Updated: 2018-09-12T13:42:11+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \pf\bigl(\ysi{0}, \ygi{0} \| \yf, n,N, \yIc\bigr)  =
\frac{(N+C)\,(n x_{\ysi{0}, \ygi{0}}+1)}{N\,(n+C)} - \frac{1}{N}.
\end{equation}

For large $C$ this is approximately
\begin{equation}
    \label{eq:joint_prob_new_ind_full_const_prior_final_approx}
    \pf\bigl(\ysi{0}, \ygi{0} \| \yf, n,N, \yIc\bigr)  \approx
    \frac{(N-n)\,(x_{\ysi{0}, \ygi{0}}+1)}{NC}
\end{equation}
