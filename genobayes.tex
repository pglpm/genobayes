...
%% Last-Updated: 2018-11-11T17:31:43+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\fig~\ref{fig:example_distributions}: we clearly expect the frequencies of
the symptom conditional on the two alleles to be different. In fact, from
the two belief distributions we can even calculate our belief that they are
equal to within some range. For the situation of the figure, our belief
that the two frequencies are the same within $0.01$ is $3.2\%$.
\begin{figure}[b!]%{r}{0.4\linewidth} % with wrapfigure
 \centering\includegraphics[width=0.75\linewidth]{example_distr_g6_sA.pdf}\\
