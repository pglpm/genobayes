...
%% Last-Updated: 2018-09-25T14:10:03+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
consider one more gene, if we choose $\yA$ as an appropriate function of
$C$ and hence of $\gn$ \citep[\sects~3--4]{basuetal1982}. It moreover
assigns a uniform \dob\ about the frequency of each gene variation if we
choose $\yA=2$. It doesn't assign equal \dobs\ to the possible frequency
...
Theorem~2]{basuetal1982}, this initial \dob\ leads to a \dob\ for
