...
%% Last-Updated: 2018-08-24T09:36:12+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
2. Bayesian theory is that it's an extension of formal logic, the truth
calculus. In fact we'll call it \emph{probability calculus} from now on.
...
this conjectural element \citep[see for example][]{harding1976}. \footnote{This
...
\begin{quotation}
  ...
  observation
\end{quotation}
Jeffreys [quote][ref].} Likewise, in the probability calculus we need to
specify initial probabilities. These may originate in data, but they always
also include additional assumptions. The motto \enquote{let the data speak
  for themselves} is simply impossible.
