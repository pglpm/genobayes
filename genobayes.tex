...
%% Last-Updated: 2018-09-10T11:37:28+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
formulae. Functions and operators on tuples $\yx \defd (x_1,\dotsc,x_D)$, $\yy \defd
(y_1,\dotsc,y_D)$, and numbers $a$ operate component-wise. For example:
\begin{subequations}
  ...
  \begin{equation}
    \begin{gathered}
      ...
      \qquad
      \yx^{\yy} \defd \bigl( {x_1}^{y_1}, \dotsc, {x_D}^{y_D} \bigr)
      \\
...
We approach this first using finite exchangeability: we are sampling from
the Norwegian or European population. We then consider the infinite limit
and see if the results remain the same.
