...
%% Last-Updated: 2018-09-23T13:57:12+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\end{multline}
and analogous equations hold for the marginal frequency distributions $\yFs$,
$\yFg$ and the variates $\yso$, $\ygo$.
Formula~\eqref{eq:joint_prob_new_ind_F_unknown} thus connects the degrees
of belief~\eqref{eq:goal_plausibilities} and \eqref{eq:goal_ind_plausibilities}.
...
considering our \dob\ in their joint values for an individual \enquote{$0$}
chosen at random from the full population, given our data:
\begin{equation}
  \label{eq:joint_prob_new_ind}
  \pf\bigl(\ysi{0}, \ygi{0} \| \yD, \yI\bigr),
\end{equation}
and the marginal \dobs\
\begin{equation}
...
entropies of either marginal  distribution of \dobs\ if they are
