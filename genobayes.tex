...
%% Last-Updated: 2018-09-04T13:25:02+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
We want to assess the informational relevance between genetic
data\mynote{find more precise term} $\set{\yG}$ and (combinations of)
insomnia symptoms $\set{\yS}$ in the Norwegian or European population. To
assess this relevance we use data $\yD$ from a population sample. Some
assumptions or background information $\yI$ are also always present in our
assessment.

The most straightforward way to assess the informational relevance of
genetic data $\yG$ for the insomnia symptom $\yS$ is to compare
$\p(\yS \| \yG \yD \yI)$ and $\p(\yS \| \yD \yI)$. If these two
probabilities are approximately equal then the particular genetic data
...
symptoms $\set{\yS}$ and of genetic data $\set{\yG}$ by using the
...
-\sum_{\yS}\p(\yS \|\yD\yI) \ln\p(\yS \|\yD\yI)
  \label{eq:entropy_G}
\end{equation}
if $\yG$ is irrelevant to predict $\yS$
