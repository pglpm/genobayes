...
%% Last-Updated: 2018-09-04T15:49:03+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\label{def_exchangeability}
  ...
  \;\yI)
  ={}\\
  \p(\ySi{1}_{\pi(s_1)}\, \ySi{2}_{\pi(s_2)}\, \ySi{3}_{\pi(s_3)}\,\dotso \|
  \yGi{1}_{g}\, \yGi{2}_{g}\, \yGi{3}_{g}\,\dotso
  \;\yI)
\end{multline}
where $\pi$ is an arbitrary permutation of the symptom labels $s_i$. For example,
\begin{multline}
\label{def_exchangeability}
  \p(\ySi{1}_{5}\, \ySi{2}_{3}\, \ySi{3}_{6}\,\dotso \|
  \yGi{1}_{g}\, \yGi{2}_{g}\, \yGi{3}_{g}\,\dotso
  \;\yI)
  ={}\\
  \p(\ySi{1}_{6}\, \ySi{2}_{5}\, \ySi{3}_{3}\,\dotso \|
  \yGi{1}_{g}\, \yGi{2}_{g}\, \yGi{3}_{g}\,\dotso
  \;\yI).
\end{multline}

\mynote{add: partial exchangeability}
