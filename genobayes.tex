...
%% Last-Updated: 2018-09-10T12:49:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
population is $N\yF$ with $\ysum\yF=1$, that is, $N F_{\yv}$ individuals
have value $\yv$ for this variate. Most components of $\yF$ vanish because
there are vastly more variate values than individuals. The probability that
a sample of $n$ individuals has a distribution $\yf$ of variate values is
given by the multivariate hypergeometric distribution\mynote{add refs}:
\begin{equation}
