...
%% Last-Updated: 2018-09-19T13:18:01+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
We can divide this sum into three: one sum over the pairs $(\yso,
\ygo)$ which appear in our data, for which $x_{\yso, \ygo}>0$; one
sum over the remaining $\yso$; one over the remaining $\ygo$:
\begin{multline}
...
&+\yCn\,
  ...
  \\
  &-\yCn
  \frac{N-n}{N\,(n+C)}\sum_{\mathclap{\yso}}
  \ln [(N+C) n s_{\yso}+(N-n)\yCg]
  \\
  &-\yCn
  \frac{N-n}{N\,(n+C)}\sum_{\mathclap{\ygo}}
  \ln [(N+C) n s_{\ygo}+(N-n)\yCs].
  \end{aligned}
\end{multline}
