...
%% Last-Updated: 2018-09-10T13:07:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \pf(\yf \| n,\yF, N,\yI) =
\binom{n}{n\yf} \binom{N-n}{N\yF-n\yf} \binom{N}{N\yF}^{-1}.  
\end{equation}
...
theorem~\eqref{eq:F_from_f_generic} and simplifying we obtain
\begin{equation}
  \label{eq:F_from_f_specific}
  \pf(\yF \| \yf, n, N,\yI) \propto
\binom{N-n}{N\yF-n\yf} \binom{N}{N\yF}^{-1}.
\end{equation}
