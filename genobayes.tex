...
%% Last-Updated: 2018-09-13T12:46:44+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
If the probability distribution for $(\ysi{0}, \ygi{0})$ is constant, so
are the marginals. Thus we obtain, with analogous calculations,
\begin{gather}
  \label{eq:marginals_final_const_prior}
    \pf\bigl(\ysi{0} \| \yf, n,N, \yIc\bigr)  =
\frac{(N+\yCs)\,(n \yfs_{\ysi{0}}+1)}{N\,(n+\yCs)} - \frac{1}{N},
\\
    \pf\bigl(\ygi{0} \| \yf, n,N, \yIc\bigr)  =
\frac{(N+\yCg)\,(n \yfg_{\ygi{0}}+1)}{N\,(n+\yCg)} - \frac{1}{N}.
\end{gather}
