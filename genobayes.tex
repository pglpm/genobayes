...
%% Last-Updated: 2018-09-11T22:04:22+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
We can substitute this in \eqn~\eqref{eq:joint_prob_new_ind_full} and
simplify, obtaining
\begin{equation}
  \label{eq:joint_prob_new_ind_full_const_prior}
  \pf\bigl(\ysi{0}, \ygi{0} \| \yf, n,N, \yI\bigr)  =
  \sum_{\yF} X_{\ysi{0}, \ygi{0}}\,
  \binom{N+C-1}{n+C-1}^{-1}\,\yprod\binom{N\yF}{n\yf}.
\end{equation}
\mynote{Luca: looking for identities to solve this sum analytically...}
